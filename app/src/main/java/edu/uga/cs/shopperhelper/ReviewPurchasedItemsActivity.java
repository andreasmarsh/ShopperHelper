...
public class ReviewPurchasedItemsActivity extends AppCompatActivity {
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        settleCostButton = findViewById( R.id.button1 );
        ...
        myRef.addListenerForSingleValueEvent( new ValueEventListener() {
            ...
            public void onDataChange( DataSnapshot snapshot ) {
                ...
                recyclerAdapter = new PurchasedItemRecyclerAdapter( purchasedItemsList );
